<template>
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" focusable="false"
        ...
        <path
            ...
            stroke="#324350" stroke-width="3"></path>
        <path d="M7.5 21.5H16.5" stroke="#6A6F7F" stroke-width="3" stroke-linecap="round"></path>
        <path d="M12 15.5V20.5" stroke="#6A6F7F" stroke-width="4"></path>
    </svg>
</template>