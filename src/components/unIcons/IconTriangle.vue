<template>
    <svg viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" focusable="false"
        aria-hidden="true">
        ...
        <!-- <defs>
            <clipPath id="clip_triangle_arrow">
                <rect width="24" height="24" fill="currentColor" transform="translate(24) rotate(90)"></rect>
            </clipPath>
        </defs> -->
    </svg>
</template>